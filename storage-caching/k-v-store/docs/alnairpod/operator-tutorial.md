...
```shell
unset GOPATH
operator-sdk init alnairpod-operator --repo=github.com/CentaurusInfra/alnair/tree/main/storage-caching/k-v-store/alnairpod-operator
operator-sdk create api --group alnair.com --version=v1alpha1 --kind=AlnairPod --resource=true --controller=true
