...
```shell
unset GOPATH
operator-sdk init dltdeploy-operator --repo=github.com/CentaurusInfra/alnair/tree/main/storage-caching/k-v-store/dltdeploy-operator
operator-sdk create api --group alnair.com --version=v1alpha1 --kind=DLTDeploy --resource=true --controller=true
