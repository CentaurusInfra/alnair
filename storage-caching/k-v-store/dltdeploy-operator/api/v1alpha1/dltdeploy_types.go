...
// DLTDeploySpec defines the desired state of DLTDeploy
type DLTDeploySpec struct {
...
// DLTDeployStatus defines the observed state of DLTDeploy
type DLTDeployStatus struct {
...
// DLTDeploy is the Schema for the dltdeploys API
type DLTDeploy struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   DLTDeploySpec   `json:"spec,omitempty"`
	Status DLTDeployStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// DLTDeployList contains a list of DLTDeploy
type DLTDeployList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DLTDeploy `json:"items"`
}

func init() {
	SchemeBuilder.Register(&DLTDeploy{}, &DLTDeployList{})
}
